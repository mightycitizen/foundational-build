import{t as i,T as o}from"./twig-BXd3Gfe2.js";import{D as n,a as p}from"./twig-foVUGi9y.js";import"./section-T9VUd2be.js";import"./video-BTPaxiPo.js";p(o);o.cache(!1);i.twig({id:"@components/embed/video/video.twig",data:[{type:"raw",value:`<figure class="mb-0" x-data="{
	    loading: true,
	    playing: false,
	    player: null,
	    firstPlay: true,
...
`,position:{start:792,end:793}},{type:"logic",token:{type:"Twig.logic.type.setcapture",key:"intro",position:{start:793,end:808},output:[{type:"raw",value:"  ",position:{start:809,end:811}},{type:"logic",token:{type:"Twig.logic.type.if",stack:[{type:"Twig.expression.type.variable",value:"section_heading",match:["section_heading"]},{type:"Twig.expression.type.filter",value:"default",match:["| default","default"]}],position:{start:811,end:845},output:[{type:"raw",value:'      <div class="section_intro ',position:{start:846,end:878}},{type:"output",position:{start:878,end:895},stack:[{type:"Twig.expression.type.variable",value:"intro_class",match:["intro_class"],position:{start:878,end:895}}]},{type:"raw",value:` ">
  ...
  `,position:{start:3348,end:3362}}]},position:{open:{start:2914,end:2951},close:{start:3362,end:3373}}},{type:"raw",value:'  <div class="',position:{start:3374,end:3388}},{type:"logic",token:{type:"Twig.logic.type.if",stack:[{type:"Twig.expression.type.variable",value:"exclude_container",match:["exclude_container"]},{type:"Twig.expression.type.filter",value:"default",match:["| default","default"]}],position:{start:3388,end:3424},output:[{type:"raw",value:"max-w-full lg:px-0",position:{start:3424,end:3442}}]},position:{open:{start:3388,end:3424},close:{start:3442,end:3453}}},{type:"raw",value:" ",position:{start:3453,end:3454}},{type:"output",position:{start:3454,end:3481},stack:[{type:"Twig.expression.type.variable",value:"width_class",match:["width_class"],position:{start:3454,end:3481}},{type:"Twig.expression.type.filter",value:"default",match:["| default","default"],position:{start:3454,end:3481}}]},{type:"raw",value:" container ",position:{start:3481,end:3492}},{type:"output",position:{start:3492,end:3518},stack:[{type:"Twig.expression.type.variable",value:"grid_class",match:["grid_class"],position:{start:3492,end:3518}},{type:"Twig.expression.type.filter",value:"default",match:["| default","default"],position:{start:3492,end:3518}}]},{type:"raw",value:` relative z-10" >
    `,position:{start:3518,end:3540}},{type:"logic",token:{type:"Twig.logic.type.if",stack:[{type:"Twig.expression.type.variable",value:"section_style",match:["section_style"]},{type:"Twig.expression.type.filter",value:"default",match:["| default","default"]},{type:"Twig.expression.type.subexpression.end",value:")",match:[")"],expression:!0,params:[{type:"Twig.expression.type.variable",value:"section_style",match:["section_style"]},{type:"Twig.expression.type.string",value:"side"},{type:"Twig.expression.type.operator.binary",value:"==",precidence:9,associativity:"leftToRight",operator:"=="}]},{type:"Twig.expression.type.operator.binary",value:"and",precidence:13,associativity:"leftToRight",operator:"and"}],position:{start:3540,end:3602},output:[{type:"raw",value:`      <div class="grid grid-cols-12 items-center justify-center gap-y-8">
        <div class="col-span-12 lg:col-span-8">
          `,position:{start:3603,end:3735}},{type:"output",position:{start:3735,end:3746},stack:[{type:"Twig.expression.type.variable",value:"intro",match:["intro"],position:{start:3735,end:3746}}]},{type:"raw",value:`
        </div>
        <div class="col-span-12 lg:col-span-4">
          `,position:{start:3746,end:3820}},{type:"output",position:{start:3820,end:3833},stack:[{type:"Twig.expression.type.variable",value:"content",match:["content"],position:{start:3820,end:3833}}]},{type:"raw",value:`
        </div>
      </div>
    `,position:{start:3833,end:3866}}]},position:{open:{start:3540,end:3602},close:{start:3866,end:3876}}},{type:"logic",token:{type:"Twig.logic.type.else",match:["else"],position:{start:3866,end:3876},output:[{type:"raw",value:`      <div class="flex flex-col gap-y-8">
        `,position:{start:3877,end:3927}},{type:"output",position:{start:3927,end:3938},stack:[{type:"Twig.expression.type.variable",value:"intro",match:["intro"],position:{start:3927,end:3938}}]},{type:"raw",value:`
        `,position:{start:3938,end:3947}},{type:"output",position:{start:3947,end:3960},stack:[{type:"Twig.expression.type.variable",value:"content",match:["content"],position:{start:3947,end:3960}}]},{type:"raw",value:`
      </div>


    `,position:{start:3960,end:3980}}]},position:{open:{start:3866,end:3876},close:{start:3980,end:3991}}},{type:"raw",value:`
  </div>
</section>
`,position:{start:3992,end:3992}}],precompiled:!0});const a=e=>e,c=(e={})=>{const s=i.twig({id:"/Users/kfernandez/Sites/foundational-build-craft/storybook/src/stories/components/modules/video/video-module.twig",data:[{type:"logic",token:{type:"Twig.logic.type.embed",only:!1,ignoreMissing:!1,stack:[{type:"Twig.expression.type.string",value:"@components/sections/section.twig"}],withStack:[{type:"Twig.expression.type.object.start",value:"{",match:["{"]},{type:"Twig.expression.type.operator.binary",value:":",precidence:16,associativity:"rightToLeft",operator:":",key:"section_heading"},{type:"Twig.expression.type.variable",value:"section_heading",match:["section_heading"]},{type:"Twig.expression.type.filter",value:"default",match:["| default","default"]},{type:"Twig.expression.type.comma"},{type:"Twig.expression.type.operator.binary",value:":",precidence:16,associativity:"rightToLeft",operator:":",key:"padding"},{type:"Twig.expression.type.string",value:"tight"},{type:"Twig.expression.type.comma"},{type:"Twig.expression.type.operator.binary",value:":",precidence:16,associativity:"rightToLeft",operator:":",key:"section_style"},{type:"Twig.expression.type.string",value:"narrower"},{type:"Twig.expression.type.object.end",value:"}",match:["}"]}],position:{start:0,end:158},output:[{type:"raw",value:"  ",position:{start:159,end:161}},{type:"logic",token:{type:"Twig.logic.type.block",blockName:"section_content",position:{start:161,end:188},output:[{type:"raw",value:"      ",position:{start:189,end:195}},{type:"logic",token:{type:"Twig.logic.type.include",only:!1,ignoreMissing:!1,stack:[{type:"Twig.expression.type.string",value:"@components/embed/video/video.twig"}],withStack:[{type:"Twig.expression.type.object.start",value:"{",match:["{"]},{type:"Twig.expression.type.operator.binary",value:":",precidence:16,associativity:"rightToLeft",operator:":",key:"trigger"},{type:"Twig.expression.type.string",value:"click"},{type:"Twig.expression.type.object.end",value:"}",match:["}"]}],position:{start:195,end:284}},position:{start:195,end:284}},{type:"raw",value:"  ",position:{start:285,end:287}}]},position:{open:{start:161,end:188},close:{start:287,end:301}}}]},position:{open:{start:0,end:158},close:{start:302,end:316}}}],precompiled:!0});s.options.allowInlineIncludes=!0;try{let t=e.defaultAttributes?e.defaultAttributes:[];return Array.isArray(t)||(t=Object.entries(t)),a(s.render({attributes:new n(t),...e}))}catch(t){return a("An error occurred whilst rendering /Users/kfernandez/Sites/foundational-build-craft/storybook/src/stories/components/modules/video/video-module.twig: "+t.toString())}};export{c as t};
