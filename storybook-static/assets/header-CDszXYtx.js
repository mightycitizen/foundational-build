import{T as o,t}from"./twig-DGqAAA8S.js";import{a as p,D as a}from"./twig-xRDxs_F9.js";import"./logo-C5b6ZHtH.js";import"./menu-CM8MSHbB.js";import"./hamburger-BoW13af-.js";p(o);o.cache(!1);t.twig({id:"@components/navigation/menu/menu.twig",data:[{type:"raw",value:`
...
`,position:{start:11169,end:11169}}],precompiled:!0});t.twig({id:"@components/utils/hamburger/hamburger.twig",data:[{type:"logic",token:{type:"Twig.logic.type.set",key:"hamburger_class",expression:[{type:"Twig.expression.type.string",value:"bg-primary h-[3px] rounded absolute w-full"}],position:{start:0,end:72}},position:{start:0,end:72}},{type:"logic",token:{type:"Twig.logic.type.if",stack:[{type:"Twig.expression.type.variable",value:"is_demo",match:["is_demo"]},{type:"Twig.expression.type.filter",value:"default",match:["| default","default"]}],position:{start:73,end:99},output:[{type:"raw",value:'<div x-data="{ ',position:{start:100,end:115}},{type:"output",position:{start:115,end:127},stack:[{type:"Twig.expression.type.variable",value:"toggle",match:["toggle"],position:{start:115,end:127}}]},{type:"raw",value:`: false }">
