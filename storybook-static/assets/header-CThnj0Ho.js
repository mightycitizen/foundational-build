import{t as i,T as s}from"./twig-BXd3Gfe2.js";import{D as p,a}from"./twig-foVUGi9y.js";import"./logo-DXQLkoeo.js";import"./menu-Bz4vhEbl.js";import"./hamburger-DVA2nQJd.js";a(s);s.cache(!1);i.twig({id:"@components/navigation/menu/menu.twig",data:[{type:"raw",value:`
...
`,position:{start:11169,end:11169}}],precompiled:!0});i.twig({id:"@components/utils/hamburger/hamburger.twig",data:[{type:"logic",token:{type:"Twig.logic.type.set",key:"hamburger_class",expression:[{type:"Twig.expression.type.string",value:"bg-primary h-[3px] rounded absolute w-full"}],position:{start:0,end:72}},position:{start:0,end:72}},{type:"logic",token:{type:"Twig.logic.type.if",stack:[{type:"Twig.expression.type.variable",value:"is_demo",match:["is_demo"]},{type:"Twig.expression.type.filter",value:"default",match:["| default","default"]}],position:{start:73,end:99},output:[{type:"raw",value:'<div x-data="{ ',position:{start:100,end:115}},{type:"output",position:{start:115,end:127},stack:[{type:"Twig.expression.type.variable",value:"toggle",match:["toggle"],position:{start:115,end:127}}]},{type:"raw",value:`: false }">
...
`,position:{start:492,end:492}}],precompiled:!0});i.twig({id:"@components/logo/logo.twig",data:[{type:"raw",value:'<a href="',position:{start:0,end:9}},{type:"output",position:{start:9,end:88},stack:[{type:"Twig.expression.type.variable",value:"homepage",match:["homepage"],position:{start:9,end:88}},{type:"Twig.expression.type.filter",value:"default",match:["| default","default"],position:{start:9,end:88},params:[{type:"Twig.expression.type.parameter.start",value:"(",match:["("],position:{start:9,end:88}},{type:"Twig.expression.type.string",value:"/iframe.html?path=/story/pages-templates--templates",position:{start:9,end:88}},{type:"Twig.expression.type.parameter.end",value:")",match:[")"],position:{start:9,end:88},expression:!1}]}]},{type:"raw",value:`" class="logo">
...
`,position:{start:303,end:303}}],precompiled:!0});const o=e=>e,c=(e={})=>{const n=i.twig({id:"/Users/kfernandez/Sites/foundational-build-craft/storybook/src/stories/layout/wrapper/header.twig",data:[{type:"raw",value:`<script>
...
`,position:{start:1762,end:1762}}],precompiled:!0});n.options.allowInlineIncludes=!0;try{let t=e.defaultAttributes?e.defaultAttributes:[];return Array.isArray(t)||(t=Object.entries(t)),o(n.render({attributes:new p(t),...e}))}catch(t){return o("An error occurred whilst rendering /Users/kfernandez/Sites/foundational-build-craft/storybook/src/stories/layout/wrapper/header.twig: "+t.toString())}};export{c as t};
