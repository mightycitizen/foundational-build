import{t as a,T as s}from"./twig-BXd3Gfe2.js";import{D as r,a as o}from"./twig-foVUGi9y.js";import"./loader-BilhnTsy.js";o(s);s.cache(!1);a.twig({id:"@components/utils/loader/loader.twig",data:[{type:"raw",value:`<div class="loader inline-block relative w-20 h-20">
...
`,position:{start:0,end:0}}],precompiled:!0});const i=e=>e,y=(e={})=>{const n=a.twig({id:"/Users/kfernandez/Sites/foundational-build-craft/storybook/src/stories/components/embed/video/video.twig",data:[{type:"raw",value:`<figure class="mb-0" x-data="{
	    loading: true,
	    playing: false,
	    player: null,
	    firstPlay: true,
